...
const Login = () => {
    ...
    const [loginInfo, setLogInfo] = useState(false);
    ...
    return (
        <div className='my-10 flex'>
            ...
            <div className='mx-auto '>
                { loginInfo ? <div className='my-5' >
                    <button onClick={handleLogoutGoogle} className="btn  bg-white text-black border-[#e5e5e5]">
