...
export const Item = ({bidItemList}) => {
  ...
  {
    bidItemList.map(element => <BiddedItem key={element.id} element={element}> </BiddedItem>)
  }
  
  
  <h1 className='ml-3 font-semibold text-lg'>Total Bid Amount:</h1>
